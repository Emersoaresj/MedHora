package br.com.fiap.medhora.infrastructure.config.kafka;
...
public class KafkaConfig {
    ...
    @Bean
    public ConsumerFactory<String, NotificacaoConsultaDTO> consumerFactory() {
        ...
        return new DefaultKafkaConsumerFactory<>(
                ...
                new JsonDeserializer<>(NotificacaoConsultaDTO.class)
        );
    }

    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, NotificacaoConsultaDTO> kafkaListenerContainerFactory() {
        ConcurrentKafkaListenerContainerFactory<String, NotificacaoConsultaDTO> factory =
